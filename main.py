...
import PSFirmManager.psp_db as psp_db
...
while True:
    ...
    if cmd == 2:
        while True:
            ...
            print(" (4) Download PS4 Controller firmwares")
            print(" (5) Prepare USB for offline firmware update [ COMING SOON ]")
            ...
            if cmd == 4:
                while True:
                    ...
                    i = 1
                    for firm_version in ps4_db.controller_firmwares:
                        print(" (" + str(i) + ")\tDownload PS4 Controller Firmware " + firm_version + " # MD5: " + ps4_db.controller_firmwares[firm_version][0])
                        i += 1
                    print(" (0)\tReturn to main menu\n")
                    ...
                    cmd -= 1
                    firmware = list(ps4_db.controller_firmwares.keys())[cmd]
                    firmware = list(ps4_db.controller_firmwares.values())[cmd]
    ...
    if cmd == 4:
        while True:
            ...
            print(" (3) Download PS3 Dev firmwares [ COMING SOON ]")
            print(" (4) Download PS3 Syscon firmwares")
            print(" (5) Download PS3 Arcade (GEX) firmwares")
            print(" (6) Download PS3 AV-Tool firmwares")
            print(" (7) Prepare USB for offline firmware update [ COMING SOON ]")
            print(" (0) Return to main menu\n")
    ...
    if cmd == 5:
        while True:
            ...
            print("PSFirmManager v" + version + " by https://github.com/SpectrTech A.K.A. " + author + "\n")
            print(" (1) Download official PSP firmwares")
            print(" (2) Download official PSP Go firmwares")
            print(" (3) Download PSP Syscon firmwares")
            print(" (0) Return to main menu\n")
            ...
            if cmd == 1:
                while True:
                    ...
                    i = 1
                    for firm_version in psp_db.official_firmwares:
                        print(" (" + str(i) + ")\tDownload PSP Firmware " + firm_version + " # MD5: " + psp_db.official_firmwares[firm_version][0])
                        i += 1
                    print(" (0)\tReturn to main menu\n")
                    ...
                    cmd -= 1
                    firmware = list(psp_db.official_firmwares.keys())[cmd]
                    firmware = list(psp_db.official_firmwares.values())[cmd]
            ...
            if cmd == 2:
                while True:
                    ...
                    i = 1
                    for firm_version in psp_db.psp_go_official_firmwares:
                        print(" (" + str(i) + ")\tDownload PSP Firmware " + firm_version + " # MD5: " + psp_db.psp_go_official_firmwares[firm_version][0])
                        i += 1
                    print(" (0)\tReturn to main menu\n")
                    ...
                    cmd -= 1
                    firmware = list(psp_db.psp_go_official_firmwares.keys())[cmd]
                    firmware = list(psp_db.psp_go_official_firmwares.values())[cmd]
            ...
            if cmd == 3:
                while True:
                    ...
                    i = 1
                    for firm_version in psp_db.syscon_firmwares:
                        print(" (" + str(i) + ")\tDownload PSP Syscon Firmware " + firm_version + " # MD5: " + psp_db.syscon_firmwares[firm_version][0])
                        i += 1
                    print(" (0)\tReturn to main menu\n")
                    ...
                    cmd -= 1
                    firmware = list(psp_db.syscon_firmwares.keys())[cmd]
                    firmware = list(psp_db.syscon_firmwares.values())[cmd]
